...
public class WeakHandler {
    private final Callback mCallback; // hard reference to Callback. We need to keep callback in memory
    ...
    public WeakHandler(@Nullable Callback callback) {
        ...
        mExec = new ExecHandler(new WeakReference<Callback>(callback)); // Weak referencing inside ExecHandler
    }
    ...
    public WeakHandler(@NonNull Looper looper, @NonNull Callback callback) {
        mCallback = callback;
        mExec = new ExecHandler(looper, new WeakReference<Callback>(callback));
    }
